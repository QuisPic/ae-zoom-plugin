...
typedef struct _keyboard_event_data {
  ...
  wchar_t keychar;
  bool repeat;
} keyboard_event_data, key_pressed_event_data, key_released_event_data;
...
typedef struct _mouse_event_data {
  ...
  int16_t x;
  int16_t y;
} mouse_event_data, mouse_pressed_event_data, mouse_released_event_data,
...
typedef void (*dispatcher_t)(iohook_event *const, void *);
...
void iohook_set_logger_proc(logger_t logger_proc, void *user_data);
