...
const std::string MangledNames::GetCurrentItem(const A_long major_version)
{
	...
	{
	default:
		return "?GetCurrentItem@CEggApp@@QEAAXPEAPEAVBEE_Item@@PEAPEAVCPanoProjItem@@@Z";
		break;
	}
}
...
const std::string MangledNames::PointFrameToFloatSource(const A_long major_version)
{
	...
	{
	default:
		return "?PointFrameToFloatSource@CPanoProjItem@@QEAAXUM_Point@@PEAV?$M_Vector2T@N@@@Z";
		break;
	}
}
